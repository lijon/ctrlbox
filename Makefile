...
ARDUINO = arduino-0008
PORT = /dev/ttyUSB0
TARGET = ctrlbox-firmware
SRC = $(ARDUINO)/pins_arduino.c $(ARDUINO)/wiring.c \
$(ARDUINO)/wiring_analog.c $(ARDUINO)/wiring_digital.c \
$(ARDUINO)/wiring_pulse.c my_serial.c \
...
export PATH = /Files/AVR-Cross/bin:/bin:/usr/bin
...
# Default target.
all: build ctrlbox2osc

ctrlbox2osc: ctrlbox2osc.c
	gcc -o ctrlbox2osc ctrlbox2osc.c -llo
